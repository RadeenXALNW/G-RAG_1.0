...
class Library:
    ...
    def __init__(self):
        ...
        library_path="/teamspace/studios/this_studio/NeurIPS_Materials/data1/"
    ...
    def create_new_library(self, library_name, account_name="llmware_magicmind"):
        ...
        account_path=os.path.join("/teamspace/studios/this_studio/NeurIPS_Materials/data1/",account_name)
        
        if not os.path.exists(account_path):
            os.makedirs(account_path,exist_ok=True)
        print(f"account_name={account_path}")
        ...
        self.library_main_path=os.path.join("/teamspace/studios/this_studio/NeurIPS_Materials/data1/",account_name,library_name)
    ...
    def load_library(self, library_name, account_name="llmware"):
        ...
        self.account_name = account_name
        # self.library_main_path = os.path.join(LLMWareConfig.get_library_path(), account_name, library_name)
        self.library_main_path=os.path.join("/teamspace/studios/this_studio/NeurIPS_Materials/data1/", library_name)
    ...
    def check_if_library_exists(self, library_name, account_name="llmware"):
        ...
        lib_path=os.path.join("/teamspace/studios/this_studio/NeurIPS_Materials/data1/", library_name)
