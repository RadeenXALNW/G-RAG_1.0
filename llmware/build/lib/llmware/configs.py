...
class MilvusConfig:
    ...
    _conf = {"host": os.environ.get("MILVUS_HOST", "localhost"),
            ...
            "lite_folder_path": "/teamspace/studios/this_studio/RAFT_MAGICMIND/data/",
...
class SQLiteConfig:
    ...
    _conf = {"host": os.environ.get("USER_MANAGED_SQLITE_HOST", "localhost"),
            ...
            "sqlite_db_folder_path":"/teamspace/studios/this_studio/RAFT_MAGICMIND/data/",
             "user_name": "",
             "pw": "",
...
class ChromaDBConfig:
    ...
    _conf = {
        ...
        'persistent_path':"/teamspace/studios/this_studio/RAFT_MAGICMIND/data/",
        #
