...
class Library:
    ...
    def __init__(self):
        ...
        library_path="/teamspace/studios/this_studio/RAFT_MAGICMIND/data/"
    ...
    def create_new_library(self, library_name, account_name="llmware_magicmind"):
        ...
        account_path=os.path.join("/teamspace/studios/this_studio/RAFT_MAGICMIND/data/",account_name)
        ...
        self.library_main_path=os.path.join("/teamspace/studios/this_studio/RAFT_MAGICMIND/data/",account_name,library_name)
    ...
    def load_library(self, library_name, account_name="llmware"):
        ...
        self.account_name = account_name
        # self.library_main_path = os.path.join(LLMWareConfig.get_library_path(), account_name, library_name)
        self.library_main_path=os.path.join("/teamspace/studios/this_studio/RAFT_MAGICMIND/data/", library_name)
    ...
    def check_if_library_exists(self, library_name, account_name="llmware"):
        ...
        lib_path=os.path.join("/teamspace/studios/this_studio/RAFT_MAGICMIND/data/", library_name)
